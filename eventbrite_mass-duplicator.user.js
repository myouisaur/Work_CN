    ...
    const Styles = {
        init() {
            const css = `
                ...
                .eb-md-actions { display: flex; align-items: center; justify-content: flex-end; gap: 0.625rem; width: 100%; border-top: 1px solid #f3f4f6; padding-top: 1.25rem; }
                .eb-md-btn {
                    ...
                    transition: all 0.15s cubic-bezier(0.16, 1, 0.3, 1); display: inline-flex; align-items: center; justify-content: center; box-sizing: border-box; height: 2.5rem;
                }
